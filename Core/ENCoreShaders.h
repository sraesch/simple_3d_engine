...
class ENShaderGenericBumpMapSpot : public ENShaderClass
{
 public:
   ...
   void   Deactivate();
 private:
   ENint  shaderMap,BumpTex,NormalTex,shaderEnable;
};
...
class ENShaderGenericLightModelSpot : public ENShaderClass
{
 ...
 private:
   ENint shaderMap,ModelMatrix,shaderEnable;
};
...
class ENShaderGenericBumpModelOmni : public ENShaderClass
{
 public:
   ...
   void   Activate();
   void   Deactivate();
   void   SetModelMatrix(ENMatrix4X4 *mat,ENMatrix3X3 *rmat);
 private:
   ENint  shaderMap,BumpTex,NormalTex,ModelMatrix,RotMatrix,shaderEnable;
};
...
class ENCoreShaders
{
 public:
   ...
   static void   SetMatrix(ENMatrix4X4 *mat,ENMatrix3X3 *rmat);
 private:
