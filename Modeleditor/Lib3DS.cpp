...
void CLoad3DS::ReadUVCoordinates(t3DObject *pObject, tChunk *pPreviousChunk)
{
	...
	pObject->pTexVerts = new CLASSVECTOR2 [pObject->numTexVertex];
...
void CLoad3DS::ReadVertices(t3DObject *pObject, tChunk *pPreviousChunk)
{
	...
	pObject->pVerts = new CLASSVECTOR3 [pObject->numOfVerts];
	memset(pObject->pVerts, 0, sizeof(CLASSVECTOR3) * pObject->numOfVerts);
...
CLASSVECTOR3 Vector(CLASSVECTOR3 vPoint1, CLASSVECTOR3 vPoint2)
{
	CLASSVECTOR3 vVector;							// The variable to hold the resultant vector
...
CLASSVECTOR3 AddVector(CLASSVECTOR3 vVector1, CLASSVECTOR3 vVector2)
{
	CLASSVECTOR3 vResult;							// The variable to hold the resultant vector
...
CLASSVECTOR3 DivideVectorByScaler(CLASSVECTOR3 vVector1, float Scaler)
{
	CLASSVECTOR3 vResult;							// The variable to hold the resultant vector
...
CLASSVECTOR3 Cross(CLASSVECTOR3 vVector1, CLASSVECTOR3 vVector2)
{
	CLASSVECTOR3 vCross;								// The vector to hold the cross product
												// Get the X value
...
CLASSVECTOR3 Normalize(CLASSVECTOR3 vNormal)
{
...
{
	int i;
	CLASSVECTOR3 vVector1, vVector2, vNormal, vPoly[3];
	...
	for(int index = 0; index < pModel->numOfObjects; index++)
	{
		...
		CLASSVECTOR3 *pNormals		= new CLASSVECTOR3 [pObject->numOfFaces];
		CLASSVECTOR3 *pTempNormals	= new CLASSVECTOR3 [pObject->numOfFaces];
		pObject->pNormals		= new CLASSVECTOR3 [pObject->numOfVerts];
		...
		CLASSVECTOR3 vSum = {0.0, 0.0, 0.0};
		CLASSVECTOR3 vZero = vSum;
		int shared=0;
